  ...
  return (
    <div className="">
      <div className=" w-full ">
        <p className="textcolordarblue text-center fontnunito text-[45px] font-[800] leading-[60px]">
          Our Pet Collections
        </p>
        <p className="textgray fontnunito text-center text-[22px] font-[500] leading-[32px] mb-12">
          "Bring joy to your home with a furry companion from our pet
          selection."
        </p>

        <div className="flex flex-wrap w-full  gap-5 lg:justify-center">
          {collectionsData.map((collection, index) => (
            <div className={index > 2 ? `hidden w-full lg:flex lg:w-[280px] lg:h-[350px]  `:`w-full lg:w-[280px] lg:h-[350px]`}>
              <CollectionsCard
                key={index}
